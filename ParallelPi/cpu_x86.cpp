...
namespace FeatureDetector {
	...
	void cpu_x86::print(const char* label, bool yes) {
		LOG_VERBOSE(std::string(label));
		LOG_VERBOSE(yes ? "Yes" : "No");
		LOG_VERBOSE("\n");
	}
	////////////////////////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////////////////////
	...
	void cpu_x86::print() const {
		LOG_VERBOSE("CPU Vendor:\n");
		print("    AMD         = ", Vendor_AMD);
		print("    Intel       = ", Vendor_Intel);
		LOG_VERBOSE("\n");

		LOG_VERBOSE("OS Features:\n");
#ifdef _WIN32
		print("    64-bit      = ", OS_x64);
#endif
		print("    OS AVX      = ", OS_AVX);
